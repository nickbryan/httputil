...
// Ensure that RequestInterceptorStack implements the RequestInterceptor interface.
var _ RequestInterceptor = RequestInterceptorStack{}

// InterceptRequest will run each RequestInterceptor in order starting from 0. It will continue iteration
// until a non nil http.Request or error is returned, it will then return the
// http.Request and error of that call.
...
// NewEndpointWithRequestInterceptor associates the given RequestInterceptor with the specified Endpoint. It
// returns a new Endpoint with the RequestInterceptor applied. The original Endpoint remains
// unmodified.
